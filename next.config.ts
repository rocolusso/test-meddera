...
const getCsp = (isDev: boolean) => {
  ...
  const directives = [
    ...
    "img-src 'self' data: blob: https://www.google-analytics.com https://www.googletagmanager.com https://connect.facebook.net https://www.facebook.com https://www.google.com https://www.google.pl https://www.google.md https://googleads.g.doubleclick.net https://c.clarity.ms https://purecatamphetamine.github.io",
