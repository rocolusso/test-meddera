...
export default function Home({posts}:{posts:{title:string,url:string}[]}) {
    ...
    return (
      <>
          ...
          <div>
              <div className={'header sticky top-0 left-0 backdrop-blur-2xl   header container mx-auto sm:pt-10    z-40'}>
                  <div className={'flex gap-5 items-center border bg-white p-5 backdrop-blur-2xl sm:rounded-3xl sm:shadow-2xl z-50'}>
                      <Link href={'/'}>
