    ...
    return (
        <>
            ...
            <Head>
                ...
                <meta
                    name="description"
                    content="Узнайте, как альгинатная маска из бурых морских водорослей помогает глубоко увлажнить, подтянуть и успокоить кожу. Подходит для любого типа кожи и улучшает её текстуру, тон и упругость."
                />
