  ...
  return (
        <>
            ...
            <Head>
                ...
                <meta
                  name="description"
                  content="Descoperă totul despre procedura de mezoterapie facială!
                ...
                <meta
                  property="og:title"
                  content="Mezoterapie facială: Reîntinerire
                 și îmbunătățirea aspectului"
                />
                <meta
                  property="og:description"
                  content="Descoperă totul despre procedura de mezoterapie facială!
                  Introducerea substanțelor active în straturile profunde ale pielii
                  ajută la eliminarea uscăciunii, ridurilor, pigmentării și redă pielii
                  elasticitatea, prospețimea și strălucirea."
                />
