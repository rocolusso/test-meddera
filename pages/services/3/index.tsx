        ...
        <div>
            ...
            <div className={'container mx-auto'}>
                <div className={'py-10 px-5'}>
                    <h1 className={'text-[1.5rem] sm:text-[3rem] sm:text-center'}>Чистка лица</h1>
                </div>
                ...
                <div>
                    <p className={'max-w-[1000px] mx-auto py-10 px-5'}>
                        Чистка лица — косметологическая процедура, направленная на глубокое очищение кожи и улучшение её
                        текстуры и цвета. Процедура помогает удалить загрязнения, избыток кожного сала и ороговевшие
                        клетки, что способствует сокращению пор и снижению риска воспалений. Существует несколько видов
