    ...
    return (
        ...
        <>
            ...
            <Head>
                ...
                <meta
                    name="description"
                    content="Узнайте, как терапия против пигментации помогает осветлить и устранить пигментные пятна, возрастные изменения и солнечные повреждения. Сделайте кожу ровной и сияющей!"
                />


                <meta property="og:title" content="Терапия против пигментации: Решение для ровного и сияющего тона кожи"/>
                <meta property="og:description"
                      content="Узнайте, как терапия против пигментации помогает осветлить и устранить пигментные пятна, возрастные изменения и солнечные повреждения. Сделайте кожу ровной и сияющей!"/>



                <meta name="twitter:title" content="Терапия против пигментации: Решение для ровного и сияющего тона кожи"/>
