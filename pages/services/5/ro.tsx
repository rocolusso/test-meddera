        ...
        <div>
            ...
            <div className={'container mx-auto'}>
                <div className={'py-10 px-5'}>
                    <h1 className={'text-[1.5rem] sm:text-[3rem] sm:text-center'}>Carboxiterapie</h1>
                </div>
                ...
                <div>
                    <p className={'max-w-[1000px] mx-auto py-10 px-5'}>
                        Carboxiterapia este o procedură destinată îmbunătățirii stării pielii prin saturarea acesteia cu
                        dioxid de carbon, fără injecții și fără a afecta integritatea pielii. În timpul procedurii, pe
                        față se aplică un gel special care activează procesele de microcirculație și stimulează fluxul
                        de oxigen către celule. Acest lucru îmbunătățește tonusul pielii, crește elasticitatea acesteia,
                        reduce vizibilitatea ridurilor și a pigmentării și ajută în combaterea acneei și a semnelor
                        post-acnee. Carboxiterapia este potrivită pentru toate tipurile de piele și poate fi utilizată
