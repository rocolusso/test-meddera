  ...
  return (
        <>
            ...
            <Head>
                ...
                <meta
                  name="description"
                  content="Carboxiterapia este o procedură modernă, fără injecții, care
                ...
                <meta
                  property="og:title"
                  content="Carboxiterapia: Îngrijirea pielii
                fără injecții pentru fermitate și strălucire"
                />
                <meta
                  property="og:description"
                  content="Carboxiterapia este o procedură modernă, fără injecții,
                  care îmbunătățește tonusul și fermitatea pielii, reduce ridurile,
                  pigmentarea și acneea. Potrivită pentru toate tipurile de piele."
                />
