    ...
    return (
        <>
            <Head>
                ...
                <meta
                    name="description"
                    content="Карбокситерапия — современная процедура без инъекций, которая улучшает тонус и упругость кожи, уменьшает морщины, пигментацию и акне. Подходит для всех типов кожи."
                />


                <meta property="og:title" content="Карбокситерапия: Уход за кожей без инъекций для упругости и сияния"/>
                <meta property="og:description"
                      content="Карбокситерапия — современная процедура без инъекций, которая улучшает тонус и упругость кожи, уменьшает морщины, пигментацию и акне. Подходит для всех типов кожи."/>



                <meta name="twitter:title" content="Карбокситерапия: Уход за кожей без инъекций для упругости и сияния"/>
