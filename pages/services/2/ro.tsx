  ...
  return (
        <>
            <Head>
                ...
                <meta
                  name="description"
                  content="Consultație dermatologică profesionistă pentru
...
"
                ...
                <meta
                  ...
                  content="Consultație dermatologică profesionistă pentru diagnosticarea
                  și tratamentul afecțiunilor pielii. Recomandări individuale,
                  analize și plan de tratament pentru sănătatea pielii tale.
...
"
                ...
                <meta
                  name="twitter:title"
                  content="Consultație dermatologică:
                Abordare complexă pentru sănătatea pielii"
                />
                <meta
                  name="twitter:description"
                  content="Consultație dermatologică profesionistă pentru
                  diagnosticarea și tratamentul afecțiunilor pielii. Recomandări
                  individuale, analize și plan de tratament pentru sănătatea pielii tale.
                      "
                />
                        ...
                        <div className="flex justify-between items-center sm:w-full">
                            ...
                            <div className="hidden sm:block">
                                <Link
                                  ...
                                  hover:bg-black hover:underline hover:text-white p-5 duration-300 hover:scale-105"
                                >
                                    RU
                                </Link>
                            </div>
