  ...
  return (
        <>
            <Head>
                ...
                <meta
                  name="description"
                  content="Obțineți o consultație profesională la medicul dermatocosmetolog.
                ...
                <meta
                  property="og:title"
                  content="Consultația la medicul dermatocosmetolog:
                 Primul pas către o piele sănătoasă"
                />
                <meta
            ...
            <div>
                <div
                  className="sticky top-0 left-0 backdrop-blur-2xl   header container
                  mx-auto sm:pt-10   bg-white z-40"
                >
                    <div
