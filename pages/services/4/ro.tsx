  ...
  return (
        <>
            ...
            <Head>
                ...
                <meta
                  name="description"
                  content="Descoperă beneficiile masajului facial: îmbunătățirea circulației,
                  tonusului pielii, prevenirea semnelor îmbătrânirii. Tehnici variate pentru nevoile tale."
                />

                <meta
                  property="og:title"
                  content="Masaj facial – Beneficii,
                tehnici și efecte asupra pielii"
                />
                <meta
                  property="og:description"
                  content="Descoperă beneficiile masajului facial: îmbunătățirea
                  circulației, tonusului pielii, prevenirea semnelor îmbătrânirii.
                  Tehnici variate pentru nevoile tale."
                />
