        ...
        <div>
            ...
            <div className={'container mx-auto'}>
                <div className={'py-10 px-5'}>
                    <h1 className={'text-[1.5rem] sm:text-[3rem] sm:text-center'}>Терапия анти-акне</h1>
                </div>
                ...
                <div>
                    <p className={'max-w-[1000px] mx-auto py-10 px-5'}>
                        Терапия анти-акне – это процедура направленная на лечение воспалений кожи и профилактику новых
                        ...
                        Важно, что процедура подбирается индивидуально в зависимости от типа кожи и стадии заболевания.
                        Регулярные сеансы помогают не только устранить воспаления, но и предотвратить развитие постакне
                        и рубцевание.
                    </p>
                </div>
            </div>
