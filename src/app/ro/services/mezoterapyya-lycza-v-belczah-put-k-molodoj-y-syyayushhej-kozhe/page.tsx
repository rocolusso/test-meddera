...
export const metadata = {
  ...
  alternates: {
    canonical: 'https://meddera.md/ro/services/mezoterapyya-lycza-v-belczah-put-k-molodoj-y-syyayushhej-kozhe',
  },
  ...
  openGraph: {
    ...
    url: 'https://meddera.md/ro/services/mezoterapyya-lycza-v-belczah-put-k-molodoj-y-syyayushhej-kozhe',
    type: 'website',
    images: [
      {
