...
export const metadata = {
  ...
  alternates: {
    canonical: 'https://meddera.md/ro/services/botoks-v-belczah-effektyvnoe-omolozhenye-lycza',
  },
  ...
  openGraph: {
    ...
    url: 'https://meddera.md/ro/services/botoks-v-belczah-effektyvnoe-omolozhenye-lycza',
    type: 'website',
    images: [
      {
