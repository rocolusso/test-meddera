...
export const metadata = {
  ...
  alternates: {
    canonical: 'https://meddera.md/ro/services/professyonalnaya-chystka-lycza-v-belczah',
  },
  ...
  openGraph: {
    ...
    url: 'https://meddera.md/ro/services/professyonalnaya-chystka-lycza-v-belczah',
    type: 'website',
    images: [
      {
        url: 'https://meddera.md/assets/img/services/chistka_lica.png',
        width: 1200,
        height: 630,
