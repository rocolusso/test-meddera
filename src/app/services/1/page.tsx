...
export const metadata = {
  ...
  description: 'Профессиональная консультация дерматокосметолога в Бельцах. Диагностика и лечение акне, псориаза, экземы, розацеа, алопеции и других кожных заболеваний. Запишитесь на прием сегодня.',
  openGraph: {
    title: 'Консультация дерматокосметолога в Бельцах — лечение кожных заболеваний',
    description: 'Профессиональная консультация дерматокосметолога в Бельцах. Диагностика и лечение акне, псориаза, экземы, розацеа, алопеции и других кожных заболеваний. Запишитесь на прием сегодня.',
