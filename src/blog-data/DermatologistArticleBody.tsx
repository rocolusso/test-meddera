...
export function DermatologistArticleBody({ post, locale, dateModified, sections }: Props) {
  ...
  const medicalReview = post.medicalReview?.[locale] || (isRu
    ? 'Материал подготовлен специалистами клиники Meddera, Бельцы. Информация носит ознакомительный характер и не заменяет очную консультацию с врачом-дерматологом.'
    : 'Materialul a fost pregătit de specialiștii clinicii Meddera, Bălți. Informația are caracter informativ și nu înlocuiește consultația cu medicul dermatolog.'
  );
