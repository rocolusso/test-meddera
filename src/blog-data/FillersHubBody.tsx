  ...
  return (
    <>
      ...
      <section className="mb-12">
        ...
        <ul className="space-y-3">
          <li><Link href="/ro/services/konturnaya-plastyka-fylleramy-v-belczah" className="text-green-700 font-medium underline hover:text-green-900">Serviciul „Conturarea cu filler-e"</Link></li>
